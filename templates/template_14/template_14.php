...
<div id="colorlib-notfound">
    <div class="colorlib-notfound">
        ...
        <h1 id="colorlib_404_customizer_page_heading" class="colorlib-heading"><?php echo wp_kses_post( $cnfp_options['colorlib_404_customizer_page_heading'] ); ?></h1>
        <h2 id="colorlib_404_customizer_content" class="colorlib-heading"><?php echo wp_kses_post( $cnfp_options['colorlib_404_customizer_content'] ); ?></h2>
